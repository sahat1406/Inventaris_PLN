        ...
        <section class="section">
            <div class="d-flex flex-wrap align-items-stretch">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="p-4 m-3">
                        <img src="../assets/img/Logo-PLN-Nusantara-Power.jpg" alt="logo" width="150" class="shadow-light float mb-5 mt-5">
                        <h5 class="text-dark font-weight-normal"><span class="font-weight-bold">Inventarisasi Barang di PLN Nusantara Power UPDK Balikpapan</span></h5>
